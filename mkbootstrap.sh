...
_each_package() {
    for f in init.vim.d/*.lua goyo.vim.d/*.lua init.vim.d/plugins/*.lua
    do
...
_each_lsp_package() {
    for f in init.vim.d/*.lua goyo.vim.d/*.lua init.vim.d/lspconfs/*.lua goyo.vim.d/lspconfs/*lua init.vim.d/plugins/*.lua
    do
